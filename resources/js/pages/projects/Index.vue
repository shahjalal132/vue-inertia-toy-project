<template>
    ...
    <div class="max-w-5xl mx-auto py-10 px-6">
        ...
        <div class="flex justify-center gap-3 my-4">
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" @click="start">Start Polling</button>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" @click="stop">Stop Polling</button>
        </div>
...
let {start, stop} = usePoll(2000, {only: ['projects'],}, {autoStart: false,})
</script>